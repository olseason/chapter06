...
public class Client {
	...
	public static void main(String[] args) throws IOException {
		...
		socket.connect(new InetSocketAddress("192.168.0.182",10001));
		
		System.out.println("[서버에 연결되었습니다.]");
		
		//outputstream 메세지 보내기용 스트림 
		...
		while(true) {
			//메세지 보내기 
			//키보드 입력 
			//String str = sc.nextLine();   //new String("안녕");  -> buffer는 쟁반으로 가득차서 보내는 용도인데, 문자열이 적어 null로 표현됨 
